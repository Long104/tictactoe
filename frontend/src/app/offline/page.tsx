...
import { useTicTacToeAdapter } from "@/adapters/primary";

export default function OfflinePage() {
  const { board, currentPlayer, gameStatus, winningLine, xScore, oScore, makeMove, resetGame, resetScore } = useTicTacToeAdapter();
  ...
  return (
    <div style={{ minHeight: "100dvh", width: "100%", display: "flex", flexDirection: "column", alignItems: "center", padding: "2rem 1rem", gap: "1.5rem" }}>
      ...
      <h1 style={{ fontSize: "1.75rem", fontWeight: 800, color: "var(--text-primary)", margin: 0 }}>Play Offline (Hexagonal)</h1>
