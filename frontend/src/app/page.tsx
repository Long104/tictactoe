...
import { SocketIOAdapter, SessionStorageAdapter } from "@/adapters/secondary";
    ...
    <>
      ...
      <div style={{ minHeight: "100dvh", width: "100%", display: "flex", flexDirection: "column", alignItems: "center", padding: "3rem 1rem 2rem", gap: "2rem" }}>
        <div style={{ textAlign: "center" }}>
          <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 800, color: "var(--text-primary)", margin: "0 0 0.5rem" }}>Tic-Tac-Toe (Hexagonal)</h1>
