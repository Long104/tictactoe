...
import { SessionStorageAdapter } from "@/adapters/secondary";
import { useOnlineGameAdapter } from "@/adapters/primary";
...
export default function OnlinePage() {
  ...
  const { board, gameStatus, role, turn, score, makeMove, resetGame, resetScore } = useOnlineGameAdapter(roomId, player, sessionId);
  ...
  return (
    <div style={{ minHeight: "100dvh", width: "100%", display: "flex", flexDirection: "column", alignItems: "center", padding: "2rem 1rem", gap: "1.5rem" }}>
      ...
      <h1 style={{ fontSize: "1.75rem", fontWeight: 800, color: "var(--text-primary)", margin: 0 }}>Online Game (Hexagonal)</h1>
